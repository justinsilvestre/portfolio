...
const SKETCHBOOK = {
  chair: chairJpg,
  kusama: "http://38.media.tumblr.com/eebe6d74bd9ad18adea1ef71147536b9/tumblr_inline_n403lx9bQ61rf8kqg.jpg",
  peach: peachJpg,
  pier: "http://justinsilvestresketchbook.weebly.com/uploads/1/7/1/6/17166696/2530596_orig.jpg",
  donut: donutJpg,
  prospect1: "http://38.media.tumblr.com/75d0e9dae10e48674b2e4063fad62fa6/tumblr_inline_ml53vwzCIh1qz4rgp.jpg",
  prospect2: "http://33.media.tumblr.com/96d2ddb5d5d2d7e2c330c9c23f645344/tumblr_inline_ml53w3uKyR1qz4rgp.jpg",
  prospect3: "http://38.media.tumblr.com/f5f52ec689dd8cb87912b498bc34ab0f/tumblr_inline_ml53v1DrVz1qz4rgp.jpg",
  westvillage: "http://33.media.tumblr.com/2e95ed65925e705b6b7e9bc22f6ae82f/tumblr_inline_n403kgNuT51rf8kqg.jpg",
  harlem: "http://justinsilvestresketchbook.weebly.com/uploads/1/7/1/6/17166696/3659048_orig.jpg",
  self: selfJpg,
}
...
class IndexPage extends Component {
  ...
  render() {
    const { coder, creative, cognoscente, allClicked, active, taDah, image } = this.state

    return (
      <div id="main-content">
      	<div id="bg1" className={cn('bg', { active: active == 'coder' || taDah })}></div>
      	<div id="bg2" className={cn('bg', { active: active == 'creative' || taDah })}></div>
      	<div id="bg3" className={cn('bg', { active: active == 'cognoscente' || taDah })}></div>

      	<h1 className={cn({ 'all-clicked': allClicked })} onClick={this.reset}><span id="my-name">Justin Silvestre</span><small>Web Developer</small></h1>
      	...
      	<div id="assets">
      		...
      		<section className={cn('creative', 'details', { active: active === 'creative' })}>
                ...
                {Object.entries(WEB).map(([name, image]) =>
                  <a href={image} onClick={this.showImage(image)}><img className="thumbnail" src={THUMBS[name]} alt="" /></a>
                )}
      				<h3>sketchbook</h3>
        ...
        {image && <div id="lightbox" onClick={this.showImage(null)}><img src={image} /></div>}
      </div>
    )
  }
}
